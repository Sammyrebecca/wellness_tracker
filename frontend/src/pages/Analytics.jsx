        ...
        >
          <div className="backdrop-blur-sm bg-white/40 dark:bg-slate-800/40 rounded-xl p-4 sm:p-6 max-w-2xl">
            ...
            <div className="text-sm text-coolGray mt-1">
              Advanced visualizations of your wellness trends
            </div>
          </div>
        </div>
              ...
              <AreaChart data={chartData}>
                ...
                <Tooltip
                  ...
                  formatter={(value, name) => {
                    if (name === "mood")
                      return [value.toFixed(1), "Mood (1-5)"];
                    return [value, name];
                  }}
                />
                <Area
          ...
          <Card>
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              {[
                {
                  label: "Sleep ↔ Mood",
                  data: correlation.correlations.sleep_mood,
                },
                {
                  label: "Steps ↔ Mood",
                  data: correlation.correlations.steps_mood,
                },
                {
                  label: "Water ↔ Mood",
                  data: correlation.correlations.water_mood,
                },
              ].map(({ label, data: corr }) => (
        ...
        <Card>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="glass-card p-4">
              ...
              <div className="text-3xl font-numeric mt-1">
            ...
            <div className="glass-card p-4">
              ...
              <div className="text-3xl font-numeric mt-1">
                {stats.averages?.sleep?.toFixed(1)}h
              </div>
            </div>
            <div className="glass-card p-4">
